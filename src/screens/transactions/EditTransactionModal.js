...
export default function EditTransactionModal({ visible, onClose, onEdit, transaction }) {
        ...
        >
          ...
          <View style={styles.sheet}>
            ...
            <View style={styles.header}>
              <Text style={styles.title}>Edit Transaction ✏️</Text>
              ...
              <View style={styles.typeToggle}>
                <TouchableOpacity
                  style={[
                    ...
                    form.type === 'income' && { backgroundColor: COLORS.incomeLight },
                  ]}
                ...
                >
                  ...
                  <Text style={[
                    styles.typeText,
                    form.type === 'income' && { color: COLORS.income },
                  ]}>Income</Text>
                </TouchableOpacity>
                ...
                <TouchableOpacity
                  style={[
                    ...
                    form.type === 'expense' && { backgroundColor: COLORS.expenseLight },
                  ]}
                ...
                >
                  ...
                  <Text style={[
                    styles.typeText,
                    form.type === 'expense' && { color: COLORS.expense },
                  ]}>Expense</Text>
                </TouchableOpacity>
              </View>
